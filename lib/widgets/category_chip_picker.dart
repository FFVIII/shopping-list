...
/// leaving the current sheet. Categories can only be picked or created here
/// — deleting one is a deliberate action confined to the Category manage
/// screen in Settings, since it reassigns every item that used it.
